...
# BDD_THING_CLASSES = ['person', 'rider', 'car', 'truck', 'bus', 'train', 'motor', 'bike', 'traffic light', 'traffic sign']
...
NU_THING_DATASET_ID_TO_CONTIGUOUS_ID =  dict(
    ChainMap(*[{i: i} for i in range(10)]))